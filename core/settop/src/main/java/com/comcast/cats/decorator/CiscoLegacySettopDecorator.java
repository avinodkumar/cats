...
/**
 * {@link SettopDiagnostic} implementation for Cisco Legacy boxes (SA etc).</br></br>
 * 
 ...
 * 
 */
@Named( SettopConstants.SETTOP_DECORATOR_CISCO_LEGACY )
@Scope( "prototype" )
public class CiscoLegacySettopDecorator extends SettopDecorator implements SettopDiagnostic
{
     ...
     */
    public CiscoLegacySettopDecorator( Settop settop )
    {
        super( settop );
    ...
    {
        LOGGER.info( "Selected Diagnostic sequence : Cisco Legacy" );
