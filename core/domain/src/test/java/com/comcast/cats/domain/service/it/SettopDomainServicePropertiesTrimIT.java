 ...
 * getting trimmed or not. We should not handle this in CATS. 
 * 
 * <pre>
 * <b>Prerequisites:</b>
 * 
 ...
 * 
 */
public class SettopDomainServicePropertiesTrimIT extends BaseSettopDomainServiceIT
{
    ...
    public void testSerialNumberProperty()
    {
        try
        {
            ...
            LOGGER.debug( "Serial No :"+settopDesc.getSerialNumber()+", Length of serial No: " + settopDesc.getSerialNumber().length() );
