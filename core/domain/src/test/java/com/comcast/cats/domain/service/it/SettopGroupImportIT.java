 ...
 * 
 */
public class SettopGroupImportIT extends BaseDomainIT
{
    @Inject
    ...
    {
        importDomain( settopGroupService, SettopGroup.class, false );
    }
            ...
            if ( ( null != list ) && ( !list.isEmpty() ) )
            {
                ...
                for ( Domain domain : list )
                {
                    try
                    {
                        ...
                        if ( domain instanceof SettopGroup )
                        {
                            createSettopGroup( ( SettopGroup ) domain );
                        }
                    }
                    catch ( Exception e )
                    {
    ...
    private void createSettopGroup( SettopGroup settopGroup )
    {
        LOGGER.info( "SettopGroup= " + settopGroup );
    }
}
