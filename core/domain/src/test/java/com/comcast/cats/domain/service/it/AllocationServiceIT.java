...
/**
 * Integrations test for {@link AllocationService}.
 * 
 * <pre>
 * <b>Prerequisites:</b>
 * 
 ...
 *   cats.user.authToken        =   21321-0e7f-4ef6-8c8c-3426a7b3a390
 * </pre>
 * 
 * @author subinsugunan
 * 
...
public class AllocationServiceIT extends BaseDomainIT
{
    ...
    @Test
    public void testAllocationRelease() throws Exception
    {
        List< Allocation > list = allocationService.findActive();

        for ( Allocation allocation : list )
        {
            allocationService.release( allocation.getId(), "15578e7a-2685-471b-980d-655a2e64d2f2" );
        }
    }
