...
/**
 * This class forms the basis for testing any of the models. It creates an
 * EntityManager, begins a transaction, creates fake data, executes the tests,
 * and then rolls back the transaction so that the DB doesn't get messed up.
 */
@org.junit.Ignore
public abstract class AbstractJPABaseClass {
	...
	public void setUp() throws Exception {
		emf = Persistence.createEntityManagerFactory("key-manager-pu");
		eMgr = emf.createEntityManager();
		final EntityTransaction xact = eMgr.getTransaction();
		xact.begin();
	}
