 ...
 * 
 * <pre>
 * REQUEST : http://localhost:8080/video-recorder-service/rest/public/recorder/history/mac?macId=E4:48:C7:A8:1A:56
 * RESPONSE TYPE: XML
 * </pre>
 * 
 * @author ssugun00c
 * 
 */
public class RecordingHistoryDeserializationTest
{
    ...
    public void testRecordingHistory() throws Exception
    {
        ...
        try
        {
            ...
            inputStream = new FileInputStream( "src/test/resources/recorder-history.xml" );
