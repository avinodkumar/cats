 ...
 */
@Provider
public class VideoRecorderExceptionHandler implements ExceptionMapper< VideoRecorderException >
{
    @Override
    public Response toResponse( VideoRecorderException exception )
    {
