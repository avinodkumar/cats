...
public interface SnmpService
{
     ...
     *            only.
     * @return SnmpServiceReturnMesage The value corresponding to the Object
     *         Identifier and also the status whether success or failure
     */
    @WebMethod
    SnmpServiceReturnMesage get( @WebParam( name = "objectId" ) final String oId,
            ...
            @WebParam( name = "privacyPassword" ) final String privacyPassword );
     ...
     *            The privacy password. Optional, applicable to SNMP version 3
     *            only.
     * @return SnmpServiceReturnMesage The value passed and also the status
     *         whether operation is success or failure
     */
    @WebMethod
    SnmpServiceReturnMesage set( @WebParam( name = "objectId" ) final String oId,
            @WebParam( name = "communityName" ) final String communityName,
            @WebParam( name = "targetIP" ) final String targetIP,
            @WebParam( name = "portNumber" ) final int portNumber,
