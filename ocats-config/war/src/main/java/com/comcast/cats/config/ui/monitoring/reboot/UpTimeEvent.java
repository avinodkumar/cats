...
/**
 * Represents an event object for Uptime.
 * @author skurup00c
 *
 */
public class UpTimeEvent
{
    ...
    public UpTimeEvent(MonitorTarget monitorTarget){
    ...
    public String toString(){
        String toString = "Null UpTimeEvent: No monitorTarget available";
        if(monitorTarget != null){
            toString = "Uptime Event : monitorTarget "+monitorTarget.toString();
        }
        return toString;
    }
