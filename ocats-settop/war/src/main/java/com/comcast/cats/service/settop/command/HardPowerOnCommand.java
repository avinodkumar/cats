...
/**
 * Hard power on command.
 * 
 * @author subinsugunan
 * 
 */
public class HardPowerOnCommand extends SettopServiceBaseCommand implements SettopServiceCommand
{
    /**
     * 
     */
    private static final long serialVersionUID = -1830548925851725932L;

    public HardPowerOnCommand( SettopToken settopToken )
    {
        super( settopToken );
    }
