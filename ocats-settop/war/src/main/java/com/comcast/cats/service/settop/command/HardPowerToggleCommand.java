...
/**
 * Hard power toggle command.
 * 
 * @author subinsugunan
 * 
 */
public class HardPowerToggleCommand extends SettopServiceBaseCommand implements SettopServiceCommand
{
    /**
     * 
     */
    private static final long serialVersionUID = 2436997515522007796L;

    public HardPowerToggleCommand( SettopToken settopToken )
    {
        super( settopToken );
    }
